...
export class FileTools {
    ...
    /**
     * Strips frontmatter from the content to ensure the agent doesn't write YAML.
     */
    ...
    async createNote(path: string, content: string): Promise<string> {
        ...
        await this.app.vault.create(normalizedPath, sanitized);
    ...
    async updateNote(path: string, content: string, mode: "append" | "prepend" | "overwrite"): Promise<string> {
        ...
        return `Successfully updated note: ${normalizedPath} (${mode})`;
    }
