...
1.  
    ...
    ![A pie chart generated by the Python solver in the chat window](/images/screenshots/solver-graph.png)

    > [!NOTE] Screenshot Needed
    > Capture a generated Python graph or chart (eg a pie chart or trend line) visible within the chat window after a solver request.
    Enable Computational Solver in Settings.
