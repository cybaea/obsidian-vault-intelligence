...
*   **Computational Solver**: The agent can write and execute Python code to analyze data within your notes (e.g., "Calculate the average rating of books I read this year").
