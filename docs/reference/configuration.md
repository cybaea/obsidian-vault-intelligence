...
| Setting | Default | Description |
| :--- | :--- | :--- |
| **Chat model** | `gemini-3-flash-preview` | The main intelligence engine. <br>• **Flash:** Best for speed and agentic loops. <br>• **Pro:** Best for deep reasoning or creative writing. |
