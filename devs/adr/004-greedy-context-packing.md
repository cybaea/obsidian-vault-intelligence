...
*   **Goal**: Maximize the *breadth* of context (number of relevant files) without sacrificing the *depth* (content of the files) too much.
...
3.  **Smart Clipping**: When clipping, we don't just take the first N chars. We look for the "Keyword Match" index and extract a window *around* that keyword.
